...
from tuning.traincoco import TrainerControllerCallback
...
def train(
    ...
    if (trainer_controller_args is not None) and (
        trainer_controller_args.traincoco_config_file is not None
    ):
        tc_callback = TrainerControllerCallback(
            trainer_controller_args.traincoco_config_file,
        )
