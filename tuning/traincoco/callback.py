...
# Local
from tuning.traincoco.control import Control, OperationAction, Rule
from tuning.traincoco.controllermetrics import (
    handlers as default_metric_handlers,
)
from tuning.traincoco.controllermetrics.metricshandler import MetricHandler
from tuning.traincoco.operations import Operation
from tuning.traincoco.operations import (
    operation_handlers as default_operation_handlers,
)
from tuning.traincoco.patience import PatienceControl
...
class TrainerControllerCallback(TrainerCallback):
    ...
    def __init__(self, trainer_controller_config: Union[dict, str]):
        ...
        # Load list of valid events for the traincoco callback
